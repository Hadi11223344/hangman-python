    ...
    * After each guess, you should display to the user the 
    ...
    while remaining_guesses > 0:
      ...
      if guess in letter_guessed:
        print("You've already guessed that letter: ", get_guessed_word(secret_word, letter_guessed))
        continue
      ...
      if is_word_guessed(secret_word, letter_guessed):
        myset = set(secret_word)
        total = remaining_guesses*len(myset) 
